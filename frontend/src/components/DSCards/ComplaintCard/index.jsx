  ...
  const tableColumn = [
    {
      ...
      render: (_, { profileImage, complainerName }) => (
        <Flex align='center' gap={"small"}>
          <img src={profileImage} alt="profileImage" className={style.profileImage} />
          <div>
    ...
    },
    {
      ...
      key: "complaintName",
      render: (complaintName) => <h5 className={clsx(style.h5, "text-start")}>{complaintName}</h5>
    },
    {
    ...
    },
    {
      ...
      render: (priorityStatus) => (
        <h5
          ...
          style={{
            color: "#ffffff",
            backgroundColor: priorityStatus === "High" ? "#E74C3C" : priorityStatus === "Medium" ? "#5678E9" : priorityStatus === "Low" ? "#39973D" : "#FFFFFF",
            borderRadius: "20px",
            padding: "5px 15px"
          }}
        >
    ...
    },
    {
      ...
      render: (status) => (
        <h5
          className={style.h5}
          style={{
            color: status === "Pending" ? "#FFC313" : status === "Open" ? "#5678E9" : status === "Solve" ? "#39973D" : "#FFFFFF",
            backgroundColor: status === "Pending" ? "#FFF9E7" : status === "Open" ? "#EEF1FD" : status === "Solve" ? "#EBF5EC" : "#FFFFFF",
            borderRadius: "20px",
            padding: "5px 15px"
          }}
        >
