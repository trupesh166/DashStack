...
import styles from "./MaintenanceInvoicesModal.module.css"
    ...
    >
      ...
      <DSCard rootClass={styles.card}>
        <div className={clsx(styles.InputWrapper, "d-grid flex-column gap-4")}>
          ...
          <div className={styles.colSpan}>
            <h5 className='clr-silver'>Address</h5>
            <h5>2118 Thornridge Cir. Syracuse, Connecticu 35624</h5>
          </div>
        </div>
      </DSCard>
      ...
      <DSCard rootClass={styles.card}>
        ...
        <div className="card-grid">
          <h6>Penalty</h6>
          <h6 className='clr-danger'>{Icons.Rupee} 350.00</h6>
        </div>
        <div className="card-grid">
